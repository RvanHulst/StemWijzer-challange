var subjects = [
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        explanation:
          "De Partij voor de Dieren wil een correctief bindend referendum invoeren bij verstrekkende besluiten. Bijvoorbeeld bij het overdragen van bevoegdheden of macht aan internationale instellingen zoals de Europese Unie. Of wanneer de overheid vrijhandelsverdragen (zoals TTIP en CETA) wil sluiten die bedreiging vormen voor mens, dier, milieu en democratie."
      },
      {
        name: "50Plus",
        position: "pro",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        explanation:
          "Natuurlijk is het mooi als jongeren zich willen inzetten voor de maatschappij, maar dat is het juist als zij er zÃƒÂ©lf voor kiezen. Daarom wil D66 dit niet verplicht stellen. Scholen kunnen kiezen voor het aanbieden van een maatschappelijke stage, maar dat moet niet door de overheid worden opgelegd."
      },
      {
        name: "GroenLinks",
        position: "contra",
    ...
    parties: [
      {
        ...
        position: "pro",
        explanation:
          "Het zou eigenlijk niet nodig moeten zijn dat mensen hun leeftijd, naam of geslacht achterwege houden. Maar zolang deze vorm van discriminatie een feit is moeten we die aanpakken ÃƒÂ©n mensen de kans geven om uitgenodigd te worden voor een sollicitatiegesprek. Anoniem solliciteren biedt dat perspectief."
      },
      {
        name: "D66",
        position: "pro",
        explanation:
          "Nederlanders met een niet-westerse achtergrond zijn drie keer vaker werkloos dan Nederlanders met een westerse achtergrond. D66 wil dit verschil terugdringen. EÃƒÂ©n van de maatregelen die D66 wil nemen is het opzetten van experimenten met neutrale sollicitatie- en promotieprocedures."
      },
      {
        name: "GroenLinks",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        explanation:
          "50PLUS vindt dat alle vormen van discriminatie hoog op de agenda moeten staan. Discriminatie op de arbeidsmarkt - op welke grond dan ook - moet teruggedrongen worden. Anoniem solliciteren kan daarbij helpen; solliciteren zonder vermelding van de leeftijd bijvoorbeeld ÃƒÂ³ÃƒÂ³k."
      },
      {
        name: "Lokaal in de Kamer",
        position: "pro",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "ambivalent",
        explanation:
          "50PLUS vindt dat de sterkste schouders de zwaarste lasten moeten dragen. DÃ¡t is en blijft ons uitgangspunt. Meer belasting voor de hoogste inkomensgroepen kan aan de orde zijn, als dat per saldo inkomensverschillen ook echt kleiner maakt Ã©n ook hogere maatschappelijke welvaart oplevert. "
      },
      {
        name: "VVD",
        position: "contra",
